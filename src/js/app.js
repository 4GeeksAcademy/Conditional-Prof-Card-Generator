...
function render(variables = {}) {
  ...
  let roleItem = document.querySelector("#role");
  let rolevalue = roleItem.value;
  let valueName = nameField.value;
  let valueLastName = lastNameField.value;
  let cityItem = document.querySelector("#city");
  let cityValue = cityItem.value;
  let countryItem = document.querySelector("#country");
  let countryValue = countryItem.value;
  let positionElement = document.querySelector("#position").value;
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${valueName} ${valueLastName}</h1>
          <h2>${rolevalue}</h2>
          <h3>${cityValue}, ${countryValue} </h3>
          <ul class="${positionElement}">
